...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default='models/detect/yolov9-HWD-SE-AKCONV.yaml', help='model.yaml path')
    ...
    parser.add_argument('--project', default=ROOT / 'runsdual/train', help='save to project/name')
