...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'runsdual/train/688/weights/best.pt', help='model path(s)')
    ...
    parser.add_argument('--project', default=ROOT / 'runsdual/val', help='save to project/name')
